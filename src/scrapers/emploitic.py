    ...
    def scrape(self) -> List[Job]:
        ...
        for element in job_elements:
            try:
                ...
                try:
                    company = element.find_element(By.CSS_SELECTOR, '[data-testid="jobs-item-company"]').text
                except:
                    company = "N/A"
                ...
                try:
                    time_container = element.find_element(By.XPATH, './/div[*[@data-testid="TimelapseRoundedIcon"]]')
